			...
			<div class="container">
				...
				<ul class="nav-menu float-left">
					...
					<?php }elseif($_SESSION['ulevel'] == 'Admin'){ ?>
						...
						<li><a href="jurusan.php">Best Product</a></li>
						<li><a href="kepala-sekolah.php">About</a></li>
						<li><a href="ekstrakurikuler.php">Product</a></li>
						<li><a href="informasi.php">Gallery</a></li>
						...
						<li>
							...
							<!-- sub menu -->
							<ul class="dropdown">
								<li><a href="identitas-sekolah.php">Informasi</a></li>
								<li><a href="tentang-sekolah.php">Background</a></li>
